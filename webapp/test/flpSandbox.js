		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comwakefernzpictures-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comwakefernzpictures-display": {
								"semanticObject": "comwakefernzpictures",
								"action": "display",
								"description": "A Fiori Display Pictures application",
								"title": "Display Pictures",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.wakefern.zpictures",
									"url": sap.ui.require.toUrl("com/wakefern/zpictures")
								}
							}
						}
					}
